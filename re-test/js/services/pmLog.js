...
discoveryService.service('pmLog', function(device) {
  ...
  this.LOGKEY = {
    ...
    OTHER_SEASON_CLICK : 'NL_OTHER_SEASON_CLICK', // Req-29  // webOS3.5 : MENU_CLICK에서 변경 (other season click 시만 사용해서 가독성 용이토록 변경)
    SEARCH_AUTO_COMPLETE : 'NL_SEARCH_AUTO_COMPLETE',
    NOTICE_POPUP : 'NL_NOTICE_POPUP', // webOS3.5 추가 사항
    NOTICE_BUTTON : 'NL_NOTICE_BUTTON', // webOS3.5 추가 사항
    PREROLL_DISPLAY : 'NL_PREROLL_DISPLAY', // webOS3.5 추가 사항
    TRAILER_ACTION : 'NL_TRAILER_ACTION', // webOS3.5 추가 사항
    ...
    ST_APP_DOWN_COMPLETE : 'ST_APP_DOWN_COMPLETE',
    STUB_APP_BUTTON : 'ST_STUB_APP_BUTTON',
    FEATURED_LOG : 'ST_FEATURED',
    PANEL_NODE_CNT : 'ST_NODE_CNT',
    NSU_RESPONSE_LOG : 'ST_NSU_RESPONSE_LOG',
    AD_MAINFOCUS : 'ST_AD_MAINFOCUS', //[QEVENTSIXT-6066] MAIN 광고 이미지 클릭 후 광고 X버튼을 사방향키로 종료 후 스토어 복귀 시 FOCUS사라짐 확인
    AD_MAINBLUR : 'ST_AD_MAINBLUR' ,
    ST_AD_DEPTH3AD : 'ST_AD_DEPTH3AD',
    ST_UPDATE_TYPE : 'ST_UPDATE_TYPE',
    ST_CHANGE_BTN : 'ST_CHANGE_BTN',   //[QEVENTSIXT-14125] 앱 설치 후 앱 버튼이 변경되지 않는 이슈
    ISAD_CHECK : 'ST_ISAD_CHECK'
  };
