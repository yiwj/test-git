var drawerTmpl = '';
drawerTmpl += '<div class="drawer main-drawer">';
drawerTmpl += '<div class="drawer-tit" ng-bind="title"></div>';
...
ratingTmpl += ' ng-mouseleave="onMouseLeave($event)" style="left: 74.4rem;top: 12rem;z-index: 1;">';
...
popupAppTmpl += '<div ng-if="!hide">';
popupAppTmpl += '<div ng-if="type==\'popup\'">';
popupAppTmpl += '<div class="popup-modal-dialog" ng-if="!hide">';
popupAppTmpl += '<div class="popup-contextual pop-dialog">';
popupAppTmpl += '<div class="wrap-title-popup">';
popupAppTmpl += '<div class="pop-dialog-cont" ng-bind-html="desc | nl2br"></div>';
popupAppTmpl += '</div>';
popupAppTmpl += '<div class="wrap-btn-dialog">';
popupAppTmpl += '<div class="blank btn-popup btn-small btn01" item="btn01" ng-if="button1">';
popupAppTmpl += '<div class="area-text">';
popupAppTmpl += '<div class="text marquee" style="transition: -webkit-transform 0s linear; transform: none;" ng-bind="button1"></div>';
popupAppTmpl += '</div>';
popupAppTmpl += '</div>';
popupAppTmpl += '<div class="blank btn-popup btn-small btn02" item="btn02" ng-if="button2">';
popupAppTmpl += '<div class="area-text">';
popupAppTmpl += '<div class="text marquee" style="transition: -webkit-transform 0s linear; transform: none;" ng-bind="button2"></div>';
popupAppTmpl += '</div>';
popupAppTmpl += '</div>';
popupAppTmpl += '<div class="blank btn-popup btn-small btn03" item="btn03" ng-if="button3">';
popupAppTmpl += '<div class="area-text">';
popupAppTmpl += '<div class="text marquee" style="transition: -webkit-transform 0s linear; transform: none;" ng-bind="button3"></div>';
popupAppTmpl += '</div>';
popupAppTmpl += '</div>';
popupAppTmpl += '</div>';
popupAppTmpl += '</div>';
...
popupAppTmpl += '<div class="popup-contextual pop-dialog">';
popupAppTmpl += '<div class="wrap-title-popup">';
popupAppTmpl += '<div class="pop-dialog-cont">{{errorMsg}}</div> ';
popupAppTmpl += '</div>';
popupAppTmpl += '<div class="wrap-btn-dialog">';
popupAppTmpl += '<div class="blank btn-popup btn-small" item="close">';
popupAppTmpl += '<div class="area-text">';
popupAppTmpl += '<div class="text marquee" ng-bind="okTxt"></div>';
popupAppTmpl += '</div>';
popupAppTmpl += '</div>';
popupAppTmpl += '<div class="blank icon icon-code btn-cp-play"  item="error"></div>';
popupAppTmpl += '</div>';
popupAppTmpl += '</div>';
popupAppTmpl += '</div>';
popupAppTmpl += '</div>';
...
popupAppTmpl += '<div class="popup-basic">';
popupAppTmpl += '<div class="popup-header">';
popupAppTmpl += '<div class="wrap-title-popup">';
popupAppTmpl += '<div class="area-text no-event popup-title">';
popupAppTmpl += '<div class="marquee text marquee-start" ng-bind="title"></div>';
popupAppTmpl += '</div>';
popupAppTmpl += '</div>';
...
popupAppTmpl += '<div class="pop-external-memory wrap-cont-popup btn-radio" ng-if="usbListData">';
popupAppTmpl += '<div class="blank memory-list option-list usbList{{$index}}" ng-repeat="usb in usbListData" item="usbList{{$index}}"';
popupAppTmpl += 'device-id="{{usb.deviceId}}" drive-id="{{usb.driveId}}" ng-class="{\'on\': (selectedDeviceId == usb.deviceId) && (selectedDriveId == usb.driveId)}">';
popupAppTmpl += '<div class="icon icon-bullet"></div>';
...
popupAppTmpl += '<div ng-if="type==\'watch\'" class="popup-basic">';
popupAppTmpl += '<div class="popup-header">';
popupAppTmpl += '<div class="wrap-title-popup">';
popupAppTmpl += '<div class="area-text no-event popup-title">';
popupAppTmpl += '<div class="marquee text marquee-start" ng-bind="title"></div>';
...
popupAppTmpl += '<div class="area-text"><div class="text marquee" style="transition: -webkit-transform 0s linear; transform: none;" ng-bind="watchClose">CLOSE</div></div>';
popupAppTmpl +=  '</div>';
popupAppTmpl += '</div>';
popupAppTmpl += '</div>';
popupAppTmpl += '<div class="popup-sub-text" ng-bind="desc"></div>';
popupAppTmpl += '<div class="popup-body">';
popupAppTmpl += '<div class="pop-list-cp wrap-cont-popup">';
...
popupAppTmpl += '<img ng-src="{{item.execImgUrl}}" class="thumb-img" style="width: 130px; height: 130px;">';
popupAppTmpl += '</div>';
popupAppTmpl += '<div class="area-text item-tit"><div class="marquee text" style="transition: -webkit-transform 0s linear; transform: none;">{{item.execAppName}}-{{item.execContsName}}</div></div>';
...
popupAppTmpl += '<div ng-if="type==\'commonPopup\'" class="popup-basic">';
popupAppTmpl += '<div class="popup-basic">';
popupAppTmpl += '<div class="popup-header">';
popupAppTmpl += '<div class="wrap-title-popup">';
popupAppTmpl += '<div class="area-text no-event popup-title">';
...
popupMainTmpl += '<div id="popupOkBtn" class="blank button btn btn-large" item="ok">';
...
playerTmpl += '</video>';
playerTmpl += '<div class="player_thumb" item="imgPoster" style="display: block;"></div>';
playerTmpl += '<div class="player-header" item="header" ng-class="{\'headOpen\': headOpen, \'video-header\': isMovie}" ng-hide="headHide" ng-if="headOpen">';
...
playerTmpl += '<div class="player-control" ng-style="playerControlStyle">';
playerTmpl += '<div class="blank icon-player btnIcon-1 btn-jumpbackward" item="btnIcon-1" ng-if="!fromTrailerBtn"></div>';
playerTmpl += '<div class="blank icon-player btnIcon-2 btn-{{playControl}}" ng-class="{\'center\': fromTrailerBtn}" ng-init="isPause = false" item="btnIcon-2"></div>';
...
playerTmpl += '<div class="blank icon-player btnIcon-1 btn-jumpbackward" item="btnIcon-1" ng-if="!fromTrailerBtn"></div>';
playerTmpl += '<div class="blank icon-player btnIcon-2 btn-{{playControl}}" item="btnIcon-2"></div>';
playerTmpl += '<div class="blank icon-player btnIcon-3 btn-jumpforward" item="btnIcon-3" ng-if="!fromTrailerBtn"></div>';
playerTmpl += '<div class="blank icon-player btnIcon-0 btn-back" item="btnIcon-0"></div>';
...
playerTmpl += '<div class="popup-contextual pop-play-opt popup-contextual-player" ng-hide="speedHide">';
playerTmpl += '<div class="pop-play-cont btn-radio">';
...
playerTmpl += '<div class="blank item-slide item-{{$index}}" ng-repeat="item in getSlideImages()" item="item-{{$index}}">';
...
playerTmpl += '</div>';
playerTmpl += '</div>';
playerTmpl += '<div ng-hide="feedbackHide" ng-if="feedbackOpen && isMovie">';
playerTmpl += '<div class="control-feedback" ng-if="feedbackOpen"><div class="icon-control btn-{{feedbackControl}}"></div>{{moveText}}{{begintTick}}</div>';
playerTmpl += '</div>';
...
playerTmpl += '</div>';
playerTmpl += '<div class="blank btn btn-large btnReplayTrailer" item="btnReplayTrailer">';
playerTmpl += '<div class="area-text"><div class="text marquee" ng-bind="trailerEndBtn.replayTrailer"></div></div>';
playerTmpl += '</div>';
playerTmpl += '<div class="blank btn btn-large btnCloseTrailer" item="btnCloseTrailer">';
...
tooltipTmpl += '<div class="area-text no-event">';
tooltipTmpl += '<div class="marquee text">{{title}}</div><div class = "bg-empty"></div>';
tooltipTmpl += '</div>';
tooltipTmpl += '</span>';
tooltipTmpl += '</div>';
tooltipTmpl += '</div>';
...
var depth2AdTmpl = '';
depth2AdTmpl += '<div class="blank ad-banner ad-banner-depth2 item-video" ng-class="{\'focus\': adFocus && !fullScreen}" ng-show="show" item="depth2Ad" adContextIndex="{{adRes.adContextIndex}}" assetId="{{adRes.assetId}}">';
depth2AdTmpl += '</div>';

var depth3AdTmpl = '';
depth3AdTmpl += '<div class="blank ad-banner item-video ad-banner-detail" ng-class="{\'focus\': adFocus && !fullScreen}" ng-show="show" item="depth3Ad" adContextIndex="{{adRes.adContextIndex}}" assetId="{{adRes.assetId}}">';
depth2AdTmpl += '</div>';
...
var depth3AdSubTmpl = '';
depth3AdSubTmpl += '<div class="ad-dim" style="visibility:visible">';
depth3AdSubTmpl += '<div class="thumb" id="videothumb">';
depth3AdSubTmpl += '<video preload="metadata" autoplay="" style="opacity: 1; width: 100%; height: 100%;" data-time="' + new Date().getTime() + '" video-handler>';
depth3AdSubTmpl += '</video>';
depth3AdSubTmpl += '<img id="adDefaultImage" ng-src="{{defaultImg}}" style="display:none;" class="thumb-img"/>';
depth3AdSubTmpl += '<div class="icon-player icon-video"></div>';
depth3AdSubTmpl += '<div class="bg-icon"></div>';
depth3AdSubTmpl += '</div>';
//depth3AdSubTmpl += '<div class="area-text ban-text">';
//depth3AdSubTmpl += '<div class="text">AD SPONSER</div>';
//depth3AdSubTmpl += '</div>';
depth3AdSubTmpl += '<div class="info-time" style="display:none;"><div class="time-text"></div><div class="blank btn btn-icon btn-pop-close" ng-class="{\'focus\': closeFocus && fullScreen}" item="close"><div class="icon"></div></div></div>';
depth3AdSubTmpl += '<div class="blank btn btn-icon btn-pop-close img-close" style="display:none;" item="close"><div class="icon"></div></div>';
depth3AdSubTmpl += '<div class="blank btn btn-ad btn-ad-more" style="display:none;">';
depth3AdSubTmpl += '<div class="area-text"><div class="text marquee">more</div></div>';
depth3AdSubTmpl += '</div>';
depth3AdSubTmpl += '<div class="blank ad-inset-ban" style="display:none;" item="banner"><img ng-src="{{bannerImg}}" class="thumb-img"></div>';
depth3AdSubTmpl += '</div>';
...
mainAdSubTmpl += '<video preload="metadata" style="opacity: 1;" data-time="' + new Date().getTime() + '" video-handler>';
mainAdSubTmpl += '</video>';
...
headerTmpl += ' <img class="thumb-img" ng-src="{{current.src}}">';
headerTmpl += ' <div class="panel-cont">';
headerTmpl += '   <div class="main-column column-3">';
headerTmpl += '     <div class="blank item item-main-banner" item="mainImageAD" type="imageAd" adContextIndex="{{adRes.adContextIndex}}" assetId="{{adRes.assetId}}">';
headerTmpl += '       <div class="wrap-spinner" ng-if="adSpinner">';
headerTmpl += '         <div class="spinner"></div>';
headerTmpl += '       </div>';
headerTmpl += '       <div class="item-thumb" ng-hide="!isAd">';
headerTmpl += '         <img src="{{adRes.srcUrl}}" class="thumb-img" banner-image-handler>';
headerTmpl += '       </div>';
headerTmpl += '       <div class="header-banner" ng-hide="isAd">';
headerTmpl += '         <div class="item-category" ng-bind="current.genre"></div>';
headerTmpl += '         <div class="item-tit" ng-bind="current.name"></div>';
headerTmpl += '         <div class="item-text ellipsis" ng-bind="current.desc"></div>';
headerTmpl += '       </div>';
headerTmpl += '     </div>';
headerTmpl += '   </div>';
headerTmpl += '   <div class="main-column column-2">';
headerTmpl += '     <div class="blank item item-main-promotion" ng-if="item.type === \'banners\'" type="banners" idx="{{item.idx}}" item="banners" item-id="{{item.id}}" singleContentsType="{{item.singleContentsType}}" category="{{item.category}}" ng-repeat="item in banners">';
headerTmpl += '       <div class="item-thumb">';
headerTmpl += '         <img ng-src="{{item.img}}" class="thumb-img" tier1-image-resize-handler d-img-type="TB" >';
headerTmpl += '       </div>';
headerTmpl += '     </div>';
headerTmpl += '   </div>';
headerTmpl += ' </div>';
headerTmpl += '<div class="header-mask"></div>';
headerTmpl += '</div>';
