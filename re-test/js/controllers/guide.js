...
app.controller('guideController', function($scope, $controller, $element, $rootScope, focusManager, keyHandler, marquee, $timeout, device, server, eventKey, audioGuidance) {
  ...
  $scope.showViewGuide = function(scope, onCloseCallback) {
    ...
    //[QEVENTSIXT-25898]최초 스토어 진입 시 가이드화면에서 커서 활성화 상태에서 close버튼 focus on 시 포커스 사라지는 버그 처리
    if (window.PalmSystem && window.PalmSystem.cursor.visibility) {
      $scope.removeFocus('guide-close-button');
    }
  };
  ...
  var initialize = function() {
    $timeout(function(){
      ...
      //TODO 2017문구 msgLang.guide_2017_title_2
      $scope.guide_11 = msgLang.guide_2017_title_2;
      //TODO 2017문구 msgLang.guide_2017_desc_1
      $scope.guide_11_desc = msgLang.guide_2017_desc_1;
      //TODO 2017문구 msgLang.guide_2017_title_1
      $scope.guide_12 = msgLang.guide_2017_title_1;
