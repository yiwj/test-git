...
discoveryVariable.value('device', {
  ...
  isQuickStartPlusStateFlag : false,
  q: {},
  featuredMainData : {},
  localPCHeaderObj: {
    'X-Device-Product' : 'webOSTV 3.0'
    , 'X-Device-Platform' : 'W16R'
...
discoveryVariable.value('eventKey', {
  ...
  DEPTH3_AD_LOADED : 'depth3ADLoaded',
  ...
  HEADER_ADSPINNER : 'mainAdSpinner'
});