discoveryService.service('adultProcess', function($rootScope, membership, device, LunaService2) {
  ...
  var execProcess = function (itemId) {
    var luna = {
      type : 'adultProcess',
      api : 'luna://com.webos.service.membership/getValue',
      debugApi : './resources/assets/requestMembershipService.json',
  ...
  this.execProcess = function (itemId) {
    execProcess(itemId);
  };
  ...
  var methodPopOrDraw = function (userStatus, appId) {
    switch(userStatus) {
      ...
      case 'notVerified':
        ...
        subTitle = msgLang.alert_adult_1_9;
      ...
      case 'needAge':
        ...
        subTitle = msgLang.alert_adult_1_8;
      ...
      case 'false':
        ...
        title = msgLang.alert_adult_5;
        subTitle = msgLang.alert_adult_1_7;
        this.key = 'requestAdultAuth';
        break;
      default :
        // Log out 상태.
        ...
        if (!device.hasLoginSession) {
          title = msgLang.alert_adult_5;
          subTitle = msgLang.alert_adult_1_5_1;
          this.key = 'requestAdultAuth';
        } else {
